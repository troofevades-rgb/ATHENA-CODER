"""Migrate Hermes memory entries into ocode v2's per-file memory format.
...
created_at, last_used_at``). ocode v2 stores each entry as a Markdown file
    ...
    if unknown is not None:
        report.add("memory_warning", {
            ...
            "message": (
                ...
                "ocode v2 cannot read it directly. Export manually."
            ),
        })
        return
