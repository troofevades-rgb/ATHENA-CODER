...

    {
      "mcpServers": {
        "filesystem": {
          ...
          "disabled": false,
          "allowed_tools": ["read_file"],     // ocode extension: whitelist
          "disabled_tools": ["write_file"]    // ocode extension: blacklist
        }
      }
    }
...
def _register_mcp_tool(
    ...
    """Register one MCP tool into ocode's tool registry under '{server}__{tool}'."""
