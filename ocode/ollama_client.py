...
``ocode.providers.ollama`` in Phase 8.
...
provider yields — providers now yield :class:`ocode.providers.StreamChunk`.
...
class ChatChunk:
    ...
    break. Phase 8 providers yield :class:`ocode.providers.StreamChunk`."""
    content: str = ""
